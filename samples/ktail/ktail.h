...
// -listen, browsers on the network behind KWebApp's login. Its texts come
// from the catalogs in strings/ (English and German): the page takes the
// language of the request, the menus the one of the window.
...
//----------
	...
	struct Config
	{
		...
		bool    bDebug   { false };
		/// the language of the menus and notifications, a BCP 47 tag - empty takes
		/// the choice of the last run, else the system's language
		KString sLanguage;
